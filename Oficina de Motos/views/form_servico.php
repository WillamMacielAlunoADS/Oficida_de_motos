...
<div class="form-group">
      <h3>Ordem de Serviço</h3>
  		<form method="POST" action="../controllers/salvar_servico.php">
...
?>
 ...
 <br>
   ...
   <input type="text" name="valor" class="form-control" required><br>
   <div>
     <input onclick="funcao1()" class="btn btn-primary" type="submit"  value="Enviar">
   </div>
  		</form>
...
function funcao1(){
var x;
var r=confirm("Tem certeza que deseja enviar?");
if (r==true)
  {
