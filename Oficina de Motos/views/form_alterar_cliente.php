...
<?php
  ...
  $resultado = $cliente -> buscar_cliente_id($conn, $id);
...
<div class="form-group">
      <h3>Alterar Cliente</h3>
  		<form method="POST" action="../controllers/alterar_cliente.php">
        ...
        <label>CPF</label><br>
  			<input type="text" name="cpf" maxlength="14" OnKeyPress="formatar('###.###.###-##', this)" class="form-control" value="<?php echo $row -> cpf; ?>" required><br>
        <label>Telefone</label><br>
  			<input type="text" name="telefone" maxlength="12" OnKeyPress="formatar('## ####-####', this)" class="form-control" value="<?php echo $row -> telefone; ?>" required><br>
        <label>E-mail</label><br>
  			<input type="email" name="email" class="form-control" value="<?php echo $row -> email; ?>" aria-describedby="emailHelp" required><br>
        <label>Endereço</label><br>
  			<input type="text" name="endereco" class="form-control" value="<?php echo $row -> endereco; ?>" required><br>
