...
<?php
 ...
 $resultado = $moto -> buscar_moto_id($conn, $id);
...
<div class="form-group">
      <h3>Cadastro de Veiculo</h3>
  		<form method="POST" action="../controllers/alterar_moto.php">
        <input type="hidden" name="id" value="<?php  echo $row -> idmoto;?>">
  			<label>Nome</label><br>
  			<input type="text" name="nome" class="form-control" value="<?php  echo $row -> nome;?>" required><br>
        <label>Montadora</label><br>
  			<input type="text" name="montadora" class="form-control" value="<?php  echo $row -> montadora;?>" required><br>
        <label>Placa</label><br>
  			<input type="text" name="placa" maxlength="8" OnKeyPress="formatar('###-####', this)" class="form-control" value="<?php  echo $row -> placa;?>" required><br>
        <label>Ano-Fabricação</label><br>
  			<input type="text" name="ano" class="form-control" value="<?php  echo $row -> ano;?>" required><br>
