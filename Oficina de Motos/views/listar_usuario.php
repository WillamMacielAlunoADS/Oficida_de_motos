...
<html lang="en" dir="ltr">
  ...
  <br>
    ...
    include_once '../controllers/conexao.php';
  	include_once '../controllers/UsuarioDAO.php';

    $ul = new UsuarioDAO();

    $result = $ul ->listar_usuario($conn);
    echo '
     <div class="container">
...
if ($result) {
  while($row = $result->fetch(PDO::FETCH_OBJ)){
              ...
              '<td>'.$row -> senha .'</td>'.
							'<td>'. $row -> nome .'</td>
							<td><a class="btn btn-primary" href="form_alterar_usuario.php?id='.
							 $row -> idusuario.'" role="button">Alterar</a></td>';
				echo '</tr>';
				}
   }
      $conn = null;
