...
<?php
  ...
  $resultado = $peca -> buscar_peca_id($conn, $id);
...
<div class="form-group">
      <h3>Alterar Peça</h3>
  		<form method="POST" action="../controllers/alterar_peca.php">
        <input type="hidden" name="id" value="<?php  echo $row -> idpeca;?>">
  			<label>Nome</label><br>
  			<input type="text" name="nome" class="form-control" value="<?php echo $row -> nome; ?>" required><br>
        <label>Estoque</label><br>
  			<input type="number" name="estoque" class="form-control" value="<?php echo $row -> estoque; ?>" required><br>
        <label>Preço</label><br>
  			<input type="text" name="preco" class="form-control" value="<?php echo $row -> preco; ?>" required><br>
