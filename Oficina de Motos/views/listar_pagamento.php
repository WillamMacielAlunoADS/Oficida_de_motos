...
<html lang="en" dir="ltr">
  ...
  <br>
    ...
    include_once '../controllers/conexao.php';
  	include_once '../controllers/PagamentoDAO.php';

    $id_l = new PagamentoDAO();

    $result = $id_l ->buscar_pagamento_id($conn, 1);
    $lucro = $result ->fetch(PDO::FETCH_OBJ);

    echo '
     <div class="container">
			<table class="table table">
				<tr>
					<th scope="col"><h2>Lucro Total</h2></th>
				</tr>
        </div>';
if ($lucro) {
					echo '<tr>';
					echo '<td><h3>'. $lucro -> lucro .' R$</h3></td>';
          echo '</tr>';
   }
      $conn = null;
			echo "</table>";
